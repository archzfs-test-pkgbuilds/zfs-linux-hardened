...
pkgrel=1
makedepends=("linux-hardened-headers=4.15.8.a-1" "spl-linux-hardened-headers")
arch=("x86_64")
...
license=("CDDL")
depends=("kmod" "spl-linux-hardened" "zfs-utils-common=0.7.6" "linux-hardened=4.15.8.a-1")
...
package_zfs-linux-hardened-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.15.8-1-hardened/Module.symvers
}
