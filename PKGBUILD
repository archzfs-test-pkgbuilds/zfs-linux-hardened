...
pkgver=0.7.9_4.17.6.a.1
pkgrel=1
makedepends=("linux-hardened-headers=4.17.6.a-1" "spl-linux-hardened-headers")
arch=("x86_64")
...
license=("CDDL")
depends=("kmod" 'spl-linux-hardened' "zfs-utils-common=0.7.9" "linux-hardened=4.17.6.a-1")
...
build() {
    ...
    ./configure --prefix=/usr --sysconfdir=/etc --sbindir=/usr/bin --libdir=/usr/lib \
                ...
                --with-linux=/usr/lib/modules/4.17.6-1-hardened/build \
                --with-linux-obj=/usr/lib/modules/4.17.6-1-hardened/build
    make
}
...
package_zfs-linux-hardened-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.17.6-1-hardened/Module.symvers
}
